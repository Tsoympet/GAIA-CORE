...
def create_default_agent_registry() -> AgentRegistry:
    ...
    for name, description, capabilities in [
        ...
        ("gaia_vision_agent", "Vision and multimodal image analysis.", ("vision",)),
        ("gaia_audio_agent", "Audio processing, transcription, and routing.", ("audio",)),
        ...
        ("gaia_documents_agent", "Document, PDF, and spreadsheet reasoning.", ("documents",)),
        (
            "gaia_repo_agent",
            "Repository inspection and version-control analysis.",
            ("repo", "coding"),
        ),
        (
            "gaia_cad_agent",
            "CAD and engineering design artifact analysis.",
            ("cad", "engineering"),
        ),
        ("gaia_self_model_agent", "Simulated self-model and capability review.", ("self_model",)),
        (
            "gaia_reflection_agent",
            "Post-execution reflection and result critique.",
            ("reflection",),
        ),
        ...
        (
            ...
            "Internal-only idle reflection and consolidation.",
            ("idle_reflection",),
        ),
        (
