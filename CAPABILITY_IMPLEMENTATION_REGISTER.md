...
| Cognitive Kernel | PARTIAL | Typed kernel package, runtime wiring, `/kernel` API, SQLite persistence, event log, resumable interrupts | SSE/WebSocket streaming, desktop surfaces, backup/restore, full completion-standard coverage |
